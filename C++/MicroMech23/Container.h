 ...
 */
{
	...
	wallA[nrWalls].initialize(nrWalls,CPair(0.0,0.08),CPair(0.05-rightPos, 0.05), &grid);
	nrWalls++;
	wallA[nrWalls].initialize(nrWalls,CPair(0.1,0.08),CPair(0.05+rightPos, 0.05), &grid);
	nrWalls++;

	wallA[nrWalls].initialize(nrWalls,CPair(0,0.12),CPair(0.1,0.12), &grid);
	nrWalls++;
	wallA[nrWalls].initialize(nrWalls,CPair(0.1,0.12),CPair(0.1,0), &grid);
	nrWalls++;
	wallA[nrWalls].initialize(nrWalls,CPair(0.1,0),CPair(0,0), &grid);
	nrWalls++;
	wallA[nrWalls].initialize(nrWalls,CPair(0,0),CPair(0,0.12), &grid);
	nrWalls++;
	



	objectA[nrObjects].initialize(nrObjects, -10, CPair(0.041, 0.03));
	nrObjects++;
	objectA[nrObjects].initialize(nrObjects, 10, CPair(0.059, 0.03));
	nrObjects++;
 ...
 */
{
	...
	extern double rightPos;
	//wallA[0].move(CPair(0,0.08),CPair(rightPos,0.08));
	wallA[0].move(CPair(0.0,0.08),CPair(0.05-rightPos, 0.05));
	wallA[1].move(CPair(0.1,0.08),CPair(0.05+rightPos, 0.05));
