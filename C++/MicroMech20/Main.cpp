...
// ----------------------------------------
int		maxNrBalls		= 500;		// number of balls
double	minRadius		= 0.0010;	// minimum radius of the balls
double	maxRadius		= 0.0015;// radius of the balls
 ...
 *
 */
double	ceilY			= 0.1;	// upper point in y direction
double	inletFloorY		= 0.0;	// lower point in y direction at the inlet
double	outletFloorY	= -0.005;		// lower point in y direction at the outlet
...
double	k				= 500;	// linear spring constant of the contact
double	c				= 0.1;		// damping constant for the spring
double	vMean			= 0.01;	// mean velocity in m/s
