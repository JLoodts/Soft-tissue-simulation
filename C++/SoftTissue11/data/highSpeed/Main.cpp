...
double	maxStrain		= 5;
double	displacementSpeed	= 2e-1;	// m/s increment speed in the position of the northface
...
double	dt				= 2e-9;		// timestep
bool	showForces		= false;
int		showTime		= 1000;		// do showTime calculations then display the result
