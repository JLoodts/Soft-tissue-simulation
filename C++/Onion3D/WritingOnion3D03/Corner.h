...
public:
	...
	void	save4SoftTissue	( ofstream outFile , double z );
...
void Corner::save4SoftTissue( ofstream outFile, double z)
{
	// eerst werd x en y gewoon gesaved, nu worden ze omgewisseld als volgt:
	// y->z, x blijft en z wordt toegevoegd en gesaved als y
	outFile<<nr4SoftTissue<<" "<<pos.x<<" "<<z<<" "<<pos.y<<endl;
}
